...
male_jail_pop_state <-left_join(male_jail_pop_state, state_abbrevs, by = c('state'='state.abb'))
...
ggplot(state_shape_male) +
  ...
  scale_fill_continuous(low = '#132B43', high = 'red', labels = scales::label_number_si())
